  ...
  return (
    <div className="space-y-8">
      <div className="flex flex-col gap-10 px-3">
        ...
        <div>
          <h2 className="text-2xl font-semibold text-gray-700 mb-4">Waitlist Growth Over Time</h2>
          <WaitlistGraph data={waitlistData} />
        </div>
        <div>
          <h2 className="text-2xl font-semibold text-gray-700 mb-4">Waitlist Members</h2>
